        ...
        <tbody>
          ${salesItemsResult
            ...
            <tr>
              ...
              <td style="padding-top: 2px; padding-bottom: 2px; width: 15%; text-align: center; border: 1px solid black;">${
                item.product_name
              }${item.standard ? `[${item.standard}]` : ''}</td>
              <td style="padding-top: 2px; padding-bottom: 2px; width: 10%; text-align: center; border: 1px solid black;">${item.quantity.toLocaleString()}${
                item.unit ? `[${item.unit}]` : ''
              }</td>
              <td style="padding-top: 2px; padding-bottom: 2px; width: 10%; text-align: right; border: 1px solid black;">₩${item.price.toLocaleString()}</td>
              ...
              <td style="padding-top: 2px; padding-bottom: 2px; width: 25%; text-align: center; border: 1px solid black;">${
                item.description || ''
              }</td>
            </tr>
          `
